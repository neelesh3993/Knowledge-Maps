...
const DEMO_PAPERS = [
  {
    id: 0,
    author: "Abdelghani et al. (2022)",
    year: "2022",
    t: "Conversational agents for fostering curiosity-driven learning in children",
    p: 4,
    a: [2, 4],
    k: "motivation; self-efficacy; engagement; emotional support; learning attitudes",
    pubType: "Journal article",
    grade: "Primary",
    learnTopic: "Not Reported",
    media: "Not reported",
    setting: "Not reported",
    studyType: "Quantitative",
    studyPurpose: "Experiment",
  ...
  {
    id: 1,
    author: "Adair et al. (2023)",
    year: "2023",
    t: "Real-Time AI-Driven Assessment & Scaffolding That Improves Students' Mathematical Modeling during Science Inquiry",
    p: 2,
    a: [2, 3, 6],
    k: "scaffolding; dynamic support; hints; guidance; adaptive agents; intelligent tutoring",
    ...
    setting: "Classroom",
    studyType: "Quantitative",
    studyPurpose: "Feasability/Usability/Perception",
    agentType: "Pedagogical",
    agentForm: "Non-human",
    specialPop: "no",
  },
  {
    id: 2,
    author: "Alaimi et al. (2020)",
    year: "2020",
    t: "Pedagogical agents for fostering question-asking skills in children",
    p: 0,
    a: [0, 4],
    k: "agent design; realism; gender matching; gestures; appearance; embodied agents",
    pubType: "Conference proceeding",
    grade: "Primary",
    learnTopic: "Science",
    media: "Tablet",
    ...
    studyType: "Quantitative",
    studyPurpose: "Feasability/Usability/Perception",
    agentType: "Multiple roles",
    agentForm: "Non-human",
    specialPop: "no",
  },
  {
    id: 3,
    author: "Ali et al. (2020)",
    year: "2020",
    t: "A Virtual Conversational Agent for Teens with Autism Spectrum Disorder",
    p: 7,
    a: [0, 7],
    k: "autism; ADHD; special needs; accessibility; individual differences",
    pubType: "Conference proceeding",
    grade: "Unknown",
    learnTopic: "Social Skills",
    media: "Computer",
    setting: "Lab",
    studyType: "Mixed methods",
    studyPurpose: "Feasability/Usability/Perception",
    agentType: "Conversational",
    agentForm: "Human-inspired",
    specialPop: "autistic",
  },
  {
    id: 4,
    author: "Aljameel (2018)",
    year: "2018",
    t: "Development of an Arabic conversational intelligent tutoring system for children with ASD",
    p: 7,
    a: [7],
    k: "autism; ADHD; special needs; accessibility; individual differences",
    ...
    agentType: "Multiple roles",
    agentForm: "Human-inspired",
    specialPop: "autistic + non-autistic",
  },
  {
    id: 5,
    author: "Andre et al. (2014)",
    year: "2014",
    t: "Ethorobotics applied to human behaviour: can animated objects influence children?",
    p: 0,
    a: [0, 5],
    k: "agent design; realism; gestures; appearance; embodied agents",
    pubType: "Journal article",
    grade: "Primary",
    learnTopic: "Mathematics",
    media: "Other",
    setting: "Lab",
    studyType: "Quantitative",
    studyPurpose: "Experiment",
    agentType: "Not Reported",
    agentForm: "Human-inspired",
    specialPop: "no",
  },
  {
    id: 6,
    author: "Arguedas & Daradoumis (2021)",
    year: "2021",
    t: "Analysing the role of a pedagogical agent in psychological preparatory activities",
    p: 0,
    a: [0, 4],
    k: "agent design; realism; gender matching; gestures; appearance; embodied agents",
    pubType: "Journal article",
    grade: "Upper Secondary",
    learnTopic: "Computer Skills",
    media: "Computer",
    setting: "Classroom",
    studyType: "Quantitative",
    studyPurpose: "Experiment",
  ...
  },
  {
    ...
    author: "Barker (2003)",
    year: "2003",
    t: "Collaborative learning with affective artificial study companions in a VLE",
    p: 5,
    a: [4, 5],
    k: "social acceptance; human-likeness; agent personality; interaction patterns",
    pubType: "Dissertation",
    grade: "Unknown",
    learnTopic: "Not Reported",
    media: "Not reported",
  ...
  {
    id: 8,
    author: "Beege et al. (2020)",
    year: "2020",
    t: "Does the effect of enthusiasm in a pedagogical agent's voice depend on mental load?",
    p: 0,
    a: [0, 2],
    k: "agent design; realism; gender matching; gestures; appearance; embodied agents",
    pubType: "Journal article",
  ...
  {
    id: 9,
    author: "Beilharz et al. (2021)",
    year: "2021",
    t: "Development of a Positive Body Image Chatbot (KIT) With Young People",
    p: 4,
    a: [4],
    k: "motivation; self-efficacy; engagement; emotional support; learning attitudes",
    pubType: "Journal article",
    ...
    agentType: "Conversational",
    agentForm: "Non-human",
    specialPop: "body image/eating disorders",
  },
  {
    id: 10,
    author: "Bringula et al. (2018)",
    year: "2018",
    t: "Effects of pedagogical agents on students' mathematics performance",
    p: 0,
    a: [0, 3, 6],
    k: "agent design; realism; gender matching; gestures; appearance; embodied agents",
    pubType: "Journal article",
  ...
  {
    id: 11,
    author: "Cabada et al. (2017)",
    year: "2017",
    t: "Knowledge-Based System in an Affective and Intelligent Tutoring System",
    p: 3,
    a: [3, 4, 2],
    k: "mathematics; math learning; strategy instruction; arithmetic; problem-solving",
    pubType: "Other",
    grade: "Primary",
    learnTopic: "Mathematics",
    media: "Computer",
  ...
  {
    id: 12,
    author: "Carpenter (2013)",
    year: "2013",
    t: "Strategy instruction in early childhood math software",
    p: 3,
    a: [3, 0],
    k: "mathematics; math learning; strategy instruction; arithmetic; problem-solving",
    pubType: "Dissertation",
  ...
  },
  {
    ...
    year: "2023",
    t: "Designing situated learning experiences for smart cities",
    p: 2,
    a: [2, 6],
    k: "scaffolding; dynamic support; hints; guidance; adaptive agents; intelligent tutoring",
    pubType: "Journal article",
  ...
  {
    id: 14,
    author: "Chen & Chan (2008)",
    year: "2008",
    t: "Learning by Substitutive Competition: Nurturing My-Pet for Game Competition",
    p: 1,
    a: [1],
    k: "teachable agents; learning-by-teaching; protégé effect; agent self-efficacy",
    pubType: "Conference proceeding",
    grade: "Primary",
    learnTopic: "Language",
    media: "Computer",
  ...
  },
  {
    ...
    year: "2014",
    t: "When educational agents meet surrogate competition",
    p: 4,
    a: [4, 0],
    k: "motivation; self-efficacy; engagement; emotional support; learning attitudes",
    pubType: "Journal article",
  ...
  {
    id: 16,
    author: "Chen & Chou (2015)",
    year: "2015",
    t: "Enhancing middle school students' scientific learning and motivation through agent-based learning",
    p: 4,
    a: [4, 6],
    k: "motivation; self-efficacy; engagement; emotional support; learning attitudes",
    pubType: "Journal article",
  ...
  {
    id: 17,
    author: "Crossley et al. (2018)",
    year: "2018",
    t: "Modeling Math Identity and Math Success through Sentiment Analysis",
    p: 4,
    a: [3, 4],
    k: "motivation; self-efficacy; engagement; emotional support; learning attitudes",
    pubType: "Conference proceeding",
  ...
  {
    id: 18,
    author: "Daradoumis & Arguedas (2020)",
    year: "2020",
    t: "Cultivating students' reflective learning in metacognitive activities",
    p: 0,
    a: [0, 4],
    k: "agent design; realism; gender matching; gestures; appearance; embodied agents",
    pubType: "Journal article",
  ...
  {
    id: 19,
    author: "Davis & Antonenko (2017)",
    year: "2017",
    t: "Effects of Pedagogical Agent Gestures on Social Acceptance and Learning",
    p: 0,
    a: [0, 5, 6],
    k: "agent design; realism; gender matching; gestures; appearance; embodied agents",
    pubType: "Journal article",
  ...
  {
    id: 20,
    author: "Dincer & Doganay (2015)",
    year: "2015",
    t: "The impact of pedagogical agent on learners' motivation and academic success",
    p: 4,
    a: [4, 6],
    k: "motivation; self-efficacy; engagement; emotional support; learning attitudes",
    pubType: "Journal article",
    ...
    studyPurpose: "Experiment",
    agentType: "Pedagogical",
    agentForm: "Mixed - multiple agents",
    specialPop: "no",
  },
  {
    id: 21,
    author: "Dincer & Doganay (2017)",
    year: "2017",
    t: "The effects of multiple-pedagogical agents on learners' academic success, motivation, and cognitive load",
    p: 0,
    a: [0, 4, 6],
    k: "agent design; realism; gender matching; gestures; appearance; embodied agents",
    pubType: "Journal article",
  ...
  {
    id: 22,
    author: "Ericsson et al. (2023)",
    year: "2023",
    t: "From deadpan machine to relating socially: Middle school students' experiences with ECAs",
    p: 5,
    a: [0, 5],
    k: "social acceptance; human-likeness; agent personality; interaction patterns",
    pubType: "Journal article",
  ...
  {
    id: 23,
    author: "Genova et al. (2021)",
    year: "2021",
    t: "A pilot RCT of virtual reality job interview training in transition-age youth on the autism spectrum",
    p: 7,
    a: [7],
    k: "autism; ADHD; special needs; accessibility; individual differences",
    pubType: "Journal article",
    grade: "Upper Secondary",
    learnTopic: "Job Skills",
  ...
  {
    id: 24,
    author: "Grynszpan et al. (2022)",
    year: "2022",
    t: "Social gaze training for Autism Spectrum Disorder using eye-tracking and virtual humans",
    p: 7,
    a: [7],
    k: "autism; ADHD; special needs; accessibility; individual differences",
    pubType: "Journal article",
  ...
  {
    id: 25,
    author: "Haake & Gulz (2009)",
    year: "2009",
    t: "A look at the roles of look & roles in embodied pedagogical agents",
    p: 0,
    a: [0, 5],
    k: "agent design; realism; gender matching; gestures; appearance; embodied agents",
    pubType: "Journal article",
    grade: "Mix Lower Secondary - Upper Secondary",
    learnTopic: "Job Skills",
    media: "Computer",
    setting: "Classroom",
    studyType: "Mixed methods",
  ...
  {
    id: 26,
    author: "Haug et al. (2023)",
    year: "2023",
    t: "Mobile App-Based Coaching for Alcohol Prevention among Adolescents",
    p: 4,
    a: [4],
    k: "motivation; self-efficacy; engagement; emotional support; learning attitudes",
    pubType: "Journal article",
  ...
  },
  {
    ...
    author: "Holmes (2007)",
    year: "2007",
    t: "Designing agents to support learning by explaining",
    p: 1,
    a: [1, 0],
    k: "teachable agents; learning-by-teaching; protégé effect; agent self-efficacy",
    pubType: "Journal article",
  ...
  },
  {
    ...
    year: "2022",
    t: "Exploring acceptance of intelligent tutoring system with pedagogical agent",
    p: 5,
    a: [0, 3, 5],
    k: "social acceptance; human-likeness; agent personality; interaction patterns",
    pubType: "Journal article",
  ...
  {
    id: 29,
    author: "Jaques et al. (2009)",
    year: "2009",
    t: "Evaluating the affective tactics of an emotional pedagogical agent",
    p: 4,
    a: [0, 4],
    k: "motivation; self-efficacy; engagement; emotional support; learning attitudes",
    pubType: "Conference proceeding",
  ...
  },
  {
    ...
    author: "Jeon (2022)",
    year: "2022",
    t: "Exploring a self-directed interactive app for informal EFL learning",
    p: 4,
    a: [4],
    k: "motivation; self-efficacy; engagement; emotional support; learning attitudes",
    pubType: "Journal article",
  ...
  {
    id: 31,
    author: "Jing et al. (2022)",
    year: "2022",
    t: "Pedagogical agents in learning videos: which one is best for children?",
    p: 0,
    a: [0, 6],
    k: "agent design; realism; gender matching; gestures; appearance; embodied agents",
    pubType: "Journal article",
  ...
  {
    id: 32,
    author: "Johnson et al. (2013)",
    year: "2013",
    t: "Pedagogical agent signaling of multiple visual engineering representations",
    p: 0,
    a: [0, 2, 3],
    k: "agent design; realism; gender matching; gestures; appearance; embodied agents",
    pubType: "Journal article",
  ...
  {
    id: 33,
    author: "Kautzmann & Jaques (2019)",
    year: "2019",
    t: "Effects of adaptive training on metacognitive knowledge monitoring ability",
    p: 2,
    a: [2, 3],
    k: "scaffolding; dynamic support; hints; guidance; adaptive agents; intelligent tutoring",
    pubType: "Journal article",
  ...
  },
  {
    ...
    author: "Kim (2009)",
    year: "2009",
    t: "The role of learner attributes and affect determining the impact of agent presence",
    p: 4,
    a: [0, 4],
    k: "motivation; self-efficacy; engagement; emotional support; learning attitudes",
    pubType: "Journal article",
  ...
  },
  {
    ...
    year: "2017",
    t: "An embodied agent helps anxious students in mathematics learning",
    p: 4,
    a: [0, 3, 4],
    k: "motivation; self-efficacy; engagement; emotional support; learning attitudes",
    pubType: "Journal article",
  ...
  {
    id: 36,
    author: "Kim et al. (2007)",
    year: "2007",
    t: "Mathgirls: toward developing girls' positive attitude and self-efficacy",
    p: 4,
    a: [4, 3, 0],
    k: "motivation; self-efficacy; engagement; emotional support; learning attitudes",
    pubType: "Other",
  ...
  {
    id: 37,
    author: "Kizilkaya & Askar (2008)",
    year: "2008",
    t: "The effect of an embedded pedagogical agent on the students' science achievement",
    p: 0,
    a: [0, 6],
    k: "agent design; realism; gender matching; gestures; appearance; embodied agents",
    pubType: "Journal article",
    ...
    studyType: "Mixed methods",
    studyPurpose: "Experiment",
    agentType: "Motivational",
    agentForm: "Non-human",
    specialPop: "no",
  },
  {
    id: 38,
    author: "Korhonen et al. (2018)",
    year: "2018",
    t: "High Support Need and Minimally Verbal Children with Autism Playing a Computer Game",
    p: 7,
    a: [7],
    k: "autism; ADHD; special needs; accessibility; individual differences",
    pubType: "Journal article",
  ...
  {
    id: 39,
    author: "Kowatsch et al. (2021)",
    year: "2021",
    t: "Conversational agents as mediating social actors in chronic disease management",
    p: 5,
    a: [5],
    k: "social acceptance; human-likeness; agent personality; interaction patterns",
    pubType: "Journal article",
  ...
  {
    id: 40,
    author: "Law et al. (2020)",
    year: "2020",
    t: "Curiosity Notebook: A Platform for Learning by Teaching Conversational Agents",
    p: 1,
    a: [1],
    k: "teachable agents; learning-by-teaching; protégé effect; agent self-efficacy",
    pubType: "Conference proceeding",
  ...
  {
    id: 41,
    author: "Lazo et al. (2018)",
    year: "2018",
    t: "Classification of Public Elementary Students' Game Play Patterns",
    p: 6,
    a: [0, 6],
    k: "learning outcomes; knowledge acquisition; retention; transfer; academic achievement",
    pubType: "Conference proceeding",
    grade: "Primary",
    learnTopic: "Language",
    media: "Computer",
  ...
  {
    id: 42,
    author: "Lester et al. (1997)",
    year: "1997",
    t: "Animated pedagogical agents and problem-solving effectiveness",
    p: 6,
    a: [0, 6],
    k: "learning outcomes; knowledge acquisition; retention; transfer; academic achievement",
    pubType: "Conference proceeding",
  ...
  },
  {
    ...
    year: "2019",
    t: "Testing the Robustness of Inquiry Practices Once Scaffolding Is Removed",
    p: 2,
    a: [2, 6],
    k: "scaffolding; dynamic support; hints; guidance; adaptive agents; intelligent tutoring",
    pubType: "Conference proceeding",
  ...
  {
    id: 44,
    author: "Makransky et al. (2018)",
    year: "2018",
    t: "A gender matching effect in learning with pedagogical agents in VR",
    p: 0,
    a: [0, 6],
    k: "agent design; realism; gender matching; gestures; appearance; embodied agents",
    pubType: "Journal article",
  ...
  },
  {
    ...
    author: "Mei (2016)",
    year: "2016",
    t: "Improving virtual reality ASD intervention games with 3D virtual humans",
    p: 7,
    a: [0, 7],
    k: "autism; ADHD; special needs; accessibility; individual differences",
    pubType: "Dissertation",
  ...
  {
    id: 46,
    author: "Meij et al. (2015)",
    year: "2015",
    t: "Animated pedagogical agents effects on enhancing student motivation and learning",
    p: 4,
    a: [0, 4, 6],
    k: "motivation; self-efficacy; engagement; emotional support; learning attitudes",
    pubType: "Journal article",
  ...
  {
    id: 47,
    author: "Mohammadhasani et al. (2018)",
    year: "2018",
    t: "The pedagogical agent enhances mathematics learning in ADHD students",
    p: 7,
    a: [3, 7],
    k: "autism; ADHD; special needs; accessibility; individual differences",
    pubType: "Journal article",
  ...
  {
    id: 48,
    author: "Molenaar et al. (2012)",
    year: "2012",
    t: "Dynamic scaffolding of socially regulated learning in a computer-based learning environment",
    p: 2,
    a: [2, 6],
    k: "scaffolding; dynamic support; hints; guidance; adaptive agents; intelligent tutoring",
    pubType: "Journal article",
  ...
  {
    id: 49,
    author: "Moreno et al. (2001)",
    year: "2001",
    t: "The case for social agency in computer-based teaching",
    p: 0,
    a: [0, 6],
    k: "agent design; realism; gender matching; gestures; appearance; embodied agents",
    pubType: "Journal article",
  ...
  {
    id: 50,
    author: "Murray & Tenenbaum (2010)",
    year: "2010",
    t: "Computerized pedagogical agents as an educational means for developing physical self-efficacy",
    p: 4,
    a: [0, 4],
    k: "motivation; self-efficacy; engagement; emotional support; learning attitudes",
    pubType: "Journal article",
    grade: "Mix Primary - Lower Secondary",
    learnTopic: "Science",
    media: "Not reported",
    setting: "Not reported",
    studyType: "Quantitative",
  ...
  },
  {
    ...
    author: "Nguyen (2022)",
    year: "2022",
    t: "Let's teach kibot: discovering discussion patterns between student groups",
    p: 1,
    a: [1, 5],
    k: "teachable agents; learning-by-teaching; protégé effect; agent self-efficacy",
    pubType: "Journal article",
  ...
  {
    id: 52,
    author: "Nielen et al. (2017)",
    year: "2017",
    t: "Digital guidance for susceptible readers: effects on fifth graders' reading motivation",
    p: 7,
    a: [7, 4],
    k: "autism; ADHD; special needs; accessibility; individual differences",
    pubType: "Journal article",
  ...
  },
  {
    ...
    author: "Okita (2014)",
    year: "2014",
    t: "Learning from the folly of others: Learning to self-correct",
    p: 1,
    a: [1, 3],
    k: "teachable agents; learning-by-teaching; protégé effect; agent self-efficacy",
    pubType: "Journal article",
  ...
  {
    id: 54,
    author: "Ozogul et al. (2013)",
    year: "2013",
    t: "Investigating the impact of pedagogical agent gender matching and learner choice",
    p: 0,
    a: [0],
    k: "agent design; realism; gender matching; gestures; appearance; embodied agents",
    pubType: "Journal article",
  ...
  {
    id: 55,
    author: "Pérez-Marín & Pascual-Nieto (2013)",
    year: "2013",
    t: "An exploratory study on how children interact with pedagogic conversational agents",
    p: 5,
    a: [5, 0],
    k: "social acceptance; human-likeness; agent personality; interaction patterns",
    pubType: "Journal article",
  ...
  {
    id: 56,
    author: "Petersen et al. (2022)",
    year: "2022",
    t: "Pipetting in virtual reality can predict real-life pipetting performance",
    p: 0,
    a: [0, 4],
    k: "agent design; realism; gender matching; gestures; appearance; embodied agents",
    pubType: "Journal article",
  ...
  {
    id: 57,
    author: "Plant et al. (2009)",
    year: "2009",
    t: "Changing middle-school students' attitudes regarding engineering",
    p: 4,
    a: [0, 4, 3],
    k: "motivation; self-efficacy; engagement; emotional support; learning attitudes",
    pubType: "Journal article",
  ...
  {
    id: 58,
    author: "Sahimi et al. (2010)",
    year: "2010",
    t: "The pedagogical agent in online learning: effects of the degree of realism",
    p: 0,
    a: [0, 6],
    k: "agent design; realism; gender matching; gestures; appearance; embodied agents",
    pubType: "Journal article",
  ...
  {
    id: 59,
    author: "Sao Pedro et al. (2014)",
    year: "2014",
    t: "The impacts of automatic scaffolding on students' acquisition of inquiry skills",
    p: 2,
    a: [2, 6],
    k: "scaffolding; dynamic support; hints; guidance; adaptive agents; intelligent tutoring",
    pubType: "Conference proceeding",
  ...
  {
    id: 60,
    author: "Sinoo et al. (2018)",
    year: "2018",
    t: "Friendship with a robot: Children's perception of similarity",
    p: 5,
    a: [0, 5],
    k: "social acceptance; human-likeness; agent personality; interaction patterns",
    pubType: "Journal article",
  ...
  {
    id: 61,
    author: "Tärning & Silvervarg (2019)",
    year: "2019",
    t: "How design of a digital tutee's self-efficacy affects conversation and behavior",
    p: 1,
    a: [1, 4],
    k: "teachable agents; learning-by-teaching; protégé effect; agent self-efficacy",
    pubType: "Journal article",
  ...
  {
    id: 62,
    author: "Tegos et al. (2016)",
    year: "2016",
    t: "An Investigation of Conversational Agent Interventions Supporting Historical Reasoning",
    p: 2,
    a: [2, 5],
    k: "scaffolding; dynamic support; hints; guidance; adaptive agents; intelligent tutoring",
    pubType: "Conference proceeding",
  ...
  },
  {
    ...
    author: "Wei (2010)",
    year: "2010",
    t: "The effects of pedagogical agents on mathematics anxiety and mathematics learning",
    p: 4,
    a: [3, 4],
    k: "motivation; self-efficacy; engagement; emotional support; learning attitudes",
    pubType: "Dissertation",
  ...
  },
  {
    ...
    author: "Wiggins (2021)",
    year: "2021",
    t: "Examining dialogue initiative policies for conversational pedagogical agents",
    p: 2,
    a: [0, 2],
    k: "scaffolding; dynamic support; hints; guidance; adaptive agents; intelligent tutoring",
    pubType: "Dissertation",
  ...
  {
    id: 65,
    author: "Woolf et al. (2010)",
    year: "2010",
    t: "The Effect of Motivational Learning Companions on Low Achieving Students and Students with Disabilities",
    p: 4,
    a: [4, 7],
    k: "motivation; self-efficacy; engagement; emotional support; learning attitudes",
    pubType: "Conference proceeding",
    ...
    agentType: "Pedagogical",
    agentForm: "Human-inspired",
    specialPop: "Learning Disability",
  },
  {
    id: 66,
    author: "Xu (2009)",
    year: "2009",
    t: "An investigation of the effectiveness of intelligent elaborative feedback by pedagogical agents",
    p: 2,
    a: [2, 0, 6],
    k: "scaffolding; dynamic support; hints; guidance; adaptive agents; intelligent tutoring",
    pubType: "Dissertation",
  ...
  {
    id: 67,
    author: "Yalçın et al. (2022)",
    year: "2022",
    t: "An intelligent pedagogical agent to foster computational thinking",
    p: 2,
    a: [2, 6],
    k: "scaffolding; dynamic support; hints; guidance; adaptive agents; intelligent tutoring",
    pubType: "Conference proceeding",
  ...
  {
    id: 68,
    author: "Yılmaz & Kılıç-Çakmak (2012)",
    year: "2012",
    t: "Educational interface agents as social models to influence learner achievement",
    p: 0,
    a: [0, 4, 6],
    k: "agent design; realism; gender matching; gestures; appearance; embodied agents",
    pubType: "Journal article",
  ...
  {
    id: 69,
    author: "Yung & Paas (2015)",
    year: "2015",
    t: "Effects of cueing by a pedagogical agent in an instructional animation",
    p: 0,
    a: [0, 2, 6],
    k: "agent design; realism; gender matching; gestures; appearance; embodied agents",
    pubType: "Journal article",
  ...
  {
    id: 70,
    author: "Zhao et al. (2012)",
    year: "2012",
    t: "Learning-by-Teaching: Designing Teachable Agents with Intrinsic Motivation",
    p: 1,
    a: [1, 4],
    k: "teachable agents; learning-by-teaching; protégé effect; agent self-efficacy",
    pubType: "Journal article",
...
function parseUploadedCSV(text) {
  ...
  if (headers.length < 6)
    throw new Error(
      "CSV needs at least 6 columns (4 metadata + 0 filters + last 5 cluster columns). Got " +
        headers.length +
        ".",
    );
  ...
  const papers = dataRows
    .map((cells, i) => {
      ...
      const allTopicsRaw =
        cells[N - 2]?.trim().replace(/[\[\]]/g, "") || String(primaryTopic);
      const allTopics = allTopicsRaw
        .split(/[,;]/)
        .map((s) => parseInt(s.trim()))
        .filter((n) => !isNaN(n));
      const keywords = cells[N]?.trim() || "";
      if (!topicNameMap[primaryTopic])
        topicNameMap[primaryTopic] = primaryTopicName;
      const paper = {
        id: i,
        author: cells[0]?.trim() || "",
        year: cells[1]?.trim() || "",
      ...
      filterHeaders.forEach((h, j) => {
        paper[h] = cells[4 + j]?.trim() || "";
      });
      return paper;
    })
  ...
  const filterDefs = filterHeaders
    .map((h) => ({
      key: h,
      label: h.toLowerCase(),
...
function buildSparseEdges(papers) {
  const byGroup = {};
  papers.forEach((p) => {
    (byGroup[p.p] = byGroup[p.p] || []).push(p.id);
  });
  ...
  Object.values(byGroup).forEach((ids) => {
    ...
    ids.forEach((id) => {
      ...
      if (others.length)
        addEdge(id, others[Math.floor(Math.random() * others.length)]);
    });
  });
  return edges;
}
...
function ClusterGraph({
  ...
  useEffect(() => {
    ...
    const graph = new G6.Graph({
      ...
      defaultEdge: {
        style: { stroke: "#1f0e1c", lineWidth: 0.75, opacity: 0.1 },
      },
      nodeStateStyles: {
        hover: {
          lineWidth: 2,
    ...
    graph.on("node:mouseenter", (evt) => {
      ...
      const m = evt.item.getModel(),
        paper = papersByIdRef.current[m._paperId];
  ...
  useEffect(() => {
    ...
    graph.getNodes().forEach((node) => {
      const m = node.getModel(),
        paper = papersById[m._paperId];
      const active = paperPasses(paper, activeTopics, attrFilters);
      graph.updateItem(node, {
        style: {
          fill: topicColors[m._topic] || "#999",
          stroke: "rgba(31,14,28,0.2)",
          lineWidth: active ? 0.7 : 0.5,
    ...
    graph.getEdges().forEach((edge) => {
      const src = edge.getSource().getModel(),
        paper = papersById[src._paperId];
      const active = paperPasses(paper, activeTopics, attrFilters);
      graph.updateItem(edge, {
        style: {
          stroke: "#1f0e1c",
          lineWidth: 0.75,
          opacity: active ? 0.1 : 0.012,
        },
      });
    });
      ...
      {open && (
        <div className="fs-chips">
          {def.values.map((v) => (
            <button
              key={v}
              className={`chip${activeSet?.has(v) ? " on" : ""}`}
              onClick={() => onToggle(def.key, v)}
            >
              {v}
            </button>
          ))}
  ...
  return (
    ...
    >
      <div
        style={{
          background: "#f5edba",
          border: "2px dashed rgba(31,14,28,0.4)",
          borderRadius: 6,
          padding: "40px 60px",
          textAlign: "center",
      ...
      >
        ...
        <div style={{ fontSize: 12, opacity: 0.45 }}>
          col 1–4: metadata · middle: filters · last 5: clusters
        </div>
      </div>
    </div>
  );
...
export default function Nodum() {
  ...
  const [selectedModel, setSelectedModel] = useState("scibert");
  ...
  const loadData = useCallback(
    (parsedPapers, parsedFilterDefs, parsedColors, parsedNames) => {
  ...
  const handleFile = useCallback(
    (file) => {
      ...
      fetch("/api/cluster", { method: "POST", body: formData })
        .then((res) => res.json())
        .then((data) => {
          if (data.error) throw new Error(data.error);
          // Convert string keys back to integers for topicColors/topicNames
          const tc = Object.fromEntries(
            Object.entries(data.topicColors).map(([k, v]) => [parseInt(k), v]),
          );
          const tn = Object.fromEntries(
            Object.entries(data.topicNames).map(([k, v]) => [parseInt(k), v]),
          );
          loadData(data.papers, data.filterDefs, tc, tn);
  ...
  /* ── Derived ── */
  const topicIds = papers
    ? [...new Set(papers.map((p) => p.p))].sort((a, b) => a - b)
    : [];
  const topicCounts = topicIds.map((id) => ({
    id,
    name: topicNames[id] || `Topic ${id}`,
    count: papers ? papers.filter((p) => p.p === id).length : 0,
    color: topicColors[id] || "#999",
  }));
  const matchCount = papers
    ? papers.filter((p) => paperPasses(p, activeTopics, attrFilters)).length
    : 0;
  const hasAnyFilter =
    activeTopics !== null ||
    (filterDefs || []).some((d) => attrFilters[d.key]?.size > 0);
      ...
      <div className="root">
        ...
        {isDragging && (
          <div className="drag-overlay">
            <div className="drag-box">
              ...
              <div className="drag-box-sub">
                col 1–4: metadata · middle cols: auto filters · last 5: cluster
                data
              </div>
            </div>
          </div>
              ...
              <div className="home-actions">
                ...
                <div style={{ marginBottom: "12px" }}>
                  ...
                  <select
                    ...
                    style={{
                      background: "rgba(31,14,28,0.06)",
                      border: "1px solid rgba(31,14,28,0.15)",
                      borderRadius: "4px",
                      padding: "6px 10px",
                      fontSize: "12px",
                      fontFamily: "inherit",
                  ...
                  >
                    ...
                    <option value="qwen3_emb">Qwen3-Embedding</option>
                  </select>
                </div>

                {isProcessing ? (
                  <div
                    style={{ fontSize: "13px", opacity: 0.6, margin: "8px 0" }}
                  >
                    ⏳ Processing your CSV — this may take a few minutes...
                  </div>
                ) : (
                  <>
                    <button
                    ...
                    />
                    <button className="btn ghost" onClick={goToDemo}>
                      check out a demo
                    </button>
                  </>
                )}
                <div className="upload-hint">
                  expected format: <code>col 1–4</code> author, year, title,
                  abstract · <code>middle cols</code> any filter columns
                  (auto-detected) · <code>last 5</code> primary topic #, topic
                  name, all topics, all topic names, keywords
                </div>
                {uploadError && (
        ...
        <div className={`graph-page${view === "graph" ? " visible" : ""}`}>
          <nav className="nav">
            ...
            <ul className="nav-links">
              ...
              {fileName && (
                <li className="nav-file">{papers?.length} papers</li>
              )}
            </ul>
          </nav>
          ...
          <div className="graph-main">
            <div className="graph-canvas">
              ...
              <span className="graph-hint">
                scroll to zoom · drag to pan · click legend to filter
              </span>
            </div>
            ...
            <aside className="sidebar">
              <div className="sb-scroll">
                ...
                <div className="sb-sec">
                  ...
                  <div className="group-opts">
                    {["primary topic", "all topics", "keywords"].map((opt) => (
                      <div
                        key={opt}
                        className={`group-opt${groupBy === opt ? " active" : ""}`}
                ...
                <div className="legend">
                  {topicCounts.map((tc) => {
                    ...
                    return (
                      <div
                        key={tc.id}
                        className={`leg-item${!on ? " dim" : ""}`}
                        onClick={() => toggleTopic(tc.id)}
                      >
                        <span
                          className="leg-dot"
                ...
                <div className="sb-filter-header">
                  ...
                  {hasAnyFilter && (
                    <button className="sb-filter-clear" onClick={clearAll}>
                      clear all
                    </button>
                  )}
                </div>
                ...
                {filterDefs && filterDefs.length > 0 ? (
                  <>
                    <div className="match-bar">
                      ...
                      <span className="match-of">
                        of {papers?.length || 0} papers
                      </span>
                    </div>
                    <div style={{ height: 8 }} />
                    {filterDefs.map((def) => (
                  ...
                  <div className="no-filters">
                    no filter columns detected in this csv
                  </div>
                )}
              </div>
            </aside>
        ...
        {tooltip &&
          (() => {
            ...
            const filterEntries = (filterDefs || [])
              .filter((d) => p[d.key])
              .slice(0, 6);
            return (
              <div
              ...
              >
                ...
                <div className="tip-topic">
                  <span
                    className="tip-dot"
                    style={{ background: topicColors[p.p] || "#999" }}
                  />
                ...
                {filterEntries.length > 0 && (
                  <>
                    ...
                    {filterEntries.map((d) => (
                      <div className="tip-row" key={d.key}>
                        <b>{d.label}</b> · {p[d.key]}
                      </div>
                    ))}
                  </>
